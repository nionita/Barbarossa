...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 145,		-- after Clop optimisation
                    epMovingEnd  = 145,		-- with 3700 games at 15+0.25 s
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookOpen        = tme 225 212,
          ewRookConn        = tme 105  53,
          ...
          ewCenterKAtts     = tme  0 52,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 16,
          ewIsolPawns       = tme (-42) (-120),
          ewIsolPassed      = tme (-59) (-161),
          ewBackPawns       = tme (-124) (-171),
          ewBackPOpen       = tme (-29)  (-18),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-26) (-21),
          ewEnpAttacked     = tme  (-7) (-14),
          ewLastLinePenalty = tme 115 (-1),
          ewBishopPair      = tme 381 331,
          ewRedundanceRook  = tme (-19) (-78),
          ewRookPawn        = tme (-49) (-40),
          ewAdvPawn5        = tme    4 132,
          ewAdvPawn6        = tme  413 419,
