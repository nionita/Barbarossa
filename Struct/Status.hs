...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 246,		-- corrected RANSAC
                    epMovingEnd  = 246,		-- corrected RANSAC
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 5 0,
          ewKingPlaceCent   = tme 5 2,
          ewKingPlacePwns   = tme 1 7,		-- max after ~12k Clop games (ELO +23 +- 12)
          ewRookHOpen       = tme 136 103,
          ewRookOpen        = tme 127  72,
          ewRookConn        = tme  67  14,
          ewMobilityKnight  = tme 32 53,	-- Evalo 200 steps:
          ewMobilityBishop  = tme 67 17,	-- length 10, depth 6, batch 128
          ewMobilityRook    = tme 43 17,
          ewMobilityQueen   = tme  2 (-8),
          ewCenterPAtts     = tme 73 42,
          ewCenterNAtts     = tme 68 39,
          ewCenterBAtts     = tme 121 23,
          ewCenterRAtts     = tme 27 33,
          ewCenterQAtts     = tme 39 47,
          ewCenterKAtts     = tme 10 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme (-9) 22,
          ewIsolPawns       = tme (-89) (-126),
          ewIsolPassed      = tme (-76) (-109),
          ewBackPawns       = tme (-54) (-113),
          ewBackPOpen       = tme (-33) (-45),
          ewEnpHanging      = tme 22 (-70),
          ewEnpEnPrise      = tme (-83) (-22),
          ewEnpAttacked     = tme  45 36,
          ewLastLinePenalty = tme  74 50,
          ewBishopPair      = tme 113  67,
          ewRedundanceRook  = tme (-20) (-31),
          ewRookPawn        = tme (-76) (-50),
          ewAdvPawn5        = tme (-9) 40,
          ewAdvPawn6        = tme  28  40,
          ewPawnBlockP      = tme (-17) (-30),
          ewPawnBlockO      = tme (-10) (-16),
          ewPawnBlockA      = tme (-38) (-42),
