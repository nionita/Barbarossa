...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 175 193,
          ewRookOpen        = tme 223 213,
          ewRookConn        = tme 101  66,
          ewMobilityKnight  = tme 50 69,	-- Evalo 200 steps:
          ...
          ewIsolPassed      = tme (-66) (-157),
          ewBackPawns       = tme (-124) (-172),
          ewBackPOpen       = tme (-30)  (-16),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-27) (-20),
          ewEnpAttacked     = tme  (-6) (-16),
          ewLastLinePenalty = tme 116 (-2),
          ewBishopPair      = tme 381 332,
          ewRedundanceRook  = tme (-23) (-76),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    3 132,
          ewAdvPawn6        = tme  423 399,
          ewPawnBlockP      = tme (-129) (-103),
