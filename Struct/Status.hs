...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 175 194,
          ewRookOpen        = tme 224 213,
          ewRookConn        = tme 105  54,
