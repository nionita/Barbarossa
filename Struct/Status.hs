...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 4 0,	-- DSPSA
          ewKingPlaceCent   = tme 3 (-3),	-- DSPSA
          ewKingPlacePwns   = tme (-7) 4,	-- DSPSA
          ewKingPawn1       = tme  3 54,	-- DSPSA
          ewKingPawn2       = tme  1 68,	-- DSPSA
          ewRookHOpen       = tme 160 181,	-- DSPSA
          ewRookOpen        = tme 206 178,	-- DSPSA
          ewRookConn        = tme  89  59,	-- DSPSA
          ewRook7th         = tme 202 161,	-- DSPSA
          ewMobilityKnight  = tme 47 53,	-- DSPSA
          ewMobilityBishop  = tme 56 32,	-- DSPSA
          ewMobilityRook    = tme 18 38,	-- DSPSA
          ewMobilityQueen   = tme  9 16,	-- DSPSA
          ewCenterPAtts     = tme 73 53,	-- DSPSA
          ewCenterNAtts     = tme 46 36,	-- DSPSA
          ewCenterBAtts     = tme 54 35,	-- DSPSA
          ewCenterRAtts     = tme 15 22,	-- DSPSA
          ewCenterQAtts     = tme 11 51,	-- DSPSA
          ewCenterKAtts     = tme  0 62,	-- DSPSA
          ewSpace           = tme  1 0,	-- DSPSA - corrected to 1
          ewAdvAtts         = tme (-3) 16,	-- DSPSA
          ewIsolPawns       = tme (-38) (-114),	-- DSPSA
          ewIsolPassed      = tme (-63) (-144),	-- DSPSA
          ewBackPawns       = tme (-107) (-140),	-- DSPSA
          ewBackPOpen       = tme (-22) (-27),	-- DSPSA
          ewEnpHanging      = tme (-23) (-25),	-- DSPSA
          ewEnpEnPrise      = tme (-37) (-28),	-- DSPSA
          ewEnpAttacked     = tme  (-3) (-11),	-- DSPSA
          ewWepAttacked     = tme 35 74,	-- DSPSA
          ewLastLinePenalty = tme 101 0,	-- DSPSA
          ewBishopPair      = tme 386 323,	-- DSPSA
          ewBishopPawns     = tme (-24) (-55),	-- DSPSA
          ewRedundanceRook  = tme (-28) (-50),	-- DSPSA
          ewRookPawn        = tme (-44) (-31),	-- DSPSA
          ewAdvPawn5        = tme   15 107,	-- DSPSA
          ewAdvPawn6        = tme  352 333,	-- DSPSA
          ewPawnBlockP      = tme (-113) (-93),	-- DSPSA
          ewPawnBlockO      = tme  (-22) (-26),	-- DSPSA
          ewPawnBlockA      = tme  (-17) (-69),	-- DSPSA
          ewPassPawnLev     = tme 1 9	-- DSPSA
        }
