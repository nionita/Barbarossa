...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 5 0,	-- instead of 4 0
          ewKingPlaceCent   = tme 5 1,
          ewKingPlacePwns   = tme (-1) 4,
          ewKingPawn1       = tme 7 47,
          ewKingPawn2       = tme 12 62,
          ewRookHOpen       = tme 159 181,
          ewRookOpen        = tme 214 184,
          ewRookConn        = tme 92  51,
          ewMobilityKnight  = tme 46 62,
          ewMobilityBishop  = tme 53 31,
          ewMobilityRook    = tme 22 22,
          ewMobilityQueen   = tme  7  5,
          ewCenterPAtts     = tme 76 59,
          ewCenterNAtts     = tme 44 40,
          ewCenterBAtts     = tme 51 40,
          ewCenterRAtts     = tme 10 32,
          ewCenterQAtts     = tme  2 51,
          ewCenterKAtts     = tme  2 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  4 13,
          ewIsolPawns       = tme (-37) (-106),
          ewIsolPassed      = tme (-51) (-151),
          ewBackPawns       = tme (-112) (-149),
          ewBackPOpen       = tme (-23)  (-20),
          ewEnpHanging      = tme (-24) (-31),
          ewEnpEnPrise      = tme (-29) (-26),
          ewEnpAttacked     = tme  (-7) (-6),
          ewWepAttacked     = tme 50 63,
          ewLastLinePenalty = tme 106 4,
          ewBishopPair      = tme 391 321,
          ewBishopPawns     = tme (-20) (-60),
          ewRedundanceRook  = tme (-29) (-58),
          ewRookPawn        = tme (-47) (-35),
          ewAdvPawn5        = tme    6 120,
          ewAdvPawn6        = tme  356 336,
          ewPawnBlockP      = tme (-116) (-90),
          ewPawnBlockO      = tme  (-21) (-24),
          ewPawnBlockA      = tme  (-13) (-69),
          ewPassPawnLev     = tme 2 7	-- instead of 2 6
        }
