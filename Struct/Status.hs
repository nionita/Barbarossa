...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 3 1,
          ewKingPlaceCent   = tme 5 6,
          ewKingPlacePwns   = tme (-3) 4,
          ewKingPawn1       = tme 4 50,
          ewKingPawn2       = tme 15 67,
          ewRookHOpen       = tme 160 180,
          ewRookOpen        = tme 212 186,
          ewRookConn        = tme 93  52,
          ewMobilityKnight  = tme 48 61,
          ewMobilityBishop  = tme 52 27,
          ewMobilityRook    = tme 21 27,
          ewMobilityQueen   = tme  9  3,
          ewCenterPAtts     = tme 81 62,
          ewCenterNAtts     = tme 45 41,
          ewCenterBAtts     = tme 53 36,
          ewCenterRAtts     = tme 15 33,
          ewCenterQAtts     = tme  6 55,
          ewCenterKAtts     = tme  2 51,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  2 14,
          ewIsolPawns       = tme (-36) (-109),
          ewIsolPassed      = tme (-48) (-153),
          ewBackPawns       = tme (-110) (-148),
          ewBackPOpen       = tme (-25)  (-22),
          ewEnpHanging      = tme (-21) (-36),
          ewEnpEnPrise      = tme (-25) (-25),
          ewEnpAttacked     = tme  (-6) (-5),
          ewWepAttacked     = tme 51 62,
          ewLastLinePenalty = tme 110 3,
          ewBishopPair      = tme 390 320,
          ewBishopPawns     = tme (-23) (-60),
          ewRedundanceRook  = tme (-35) (-62),
          ewRookPawn        = tme (-47) (-40),
          ewAdvPawn5        = tme    6 117,
          ewAdvPawn6        = tme  356 334,
          ewPawnBlockP      = tme (-113) (-88),
          ewPawnBlockO      = tme  (-19) (-25),
          ewPawnBlockA      = tme  (-11) (-69),
