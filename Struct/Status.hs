...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 174 196,
          ewRookOpen        = tme 223 214,
          ewRookConn        = tme 104  57,
