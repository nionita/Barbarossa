...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 148,		-- after SGD optimisation
                    epMovingEnd  = 148,		-- with 500kpos, shift=0.2, epsilon=16
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 179 183,
          ewRookOpen        = tme 228 202,
          ewRookConn        = tme 106 47,
          ...
          ewCenterPAtts     = tme 83 66,
          ewCenterNAtts     = tme 48 46,
          ewCenterBAtts     = tme 55 44,
          ewCenterRAtts     = tme 10 33,
          ewCenterQAtts     = tme  4 58,
          ewCenterKAtts     = tme  2 52,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 16,
          ewIsolPawns       = tme (-41) (-120),
          ewIsolPassed      = tme (-63) (-162),
          ewBackPawns       = tme (-124) (-167),
          ewBackPOpen       = tme (-30) (-25),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-26) (-22),
          ewEnpAttacked     = tme  (-7) (-13),
          ewLastLinePenalty = tme 116 0,
          ewBishopPair      = tme 392  290,
          ewRedundanceRook  = tme (-31) (-59),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    2  130,
          ewAdvPawn6        = tme  380  369,
          ewPawnBlockP      = tme (-131) (-91),
          ewPawnBlockO      = tme  (-22) (-26),
          ewPawnBlockA      = tme  (-15) (-68),
