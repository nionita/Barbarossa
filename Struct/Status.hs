...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewCenterPAtts     = tme 67 66,	-- 1100 steps evalo
          ewCenterNAtts     = tme 52 48,
          ewCenterBAtts     = tme 60 41,
          ewCenterRAtts     = tme 11 36,
          ewCenterQAtts     = tme  4 62,
          ewCenterKAtts     = tme  0 56,
          ewAdvAtts         = tme  3 17,	-- 1100 steps evalo
          ewIsolPawns       = tme (-38) (-118),	-- and here
          ewIsolPassed      = tme (-61) (-154),	-- and here
          ewBackPawns       = tme (-101) (-181),	-- and here
          ewBackPOpen       = tme (-34)    1,	-- and here (!)
          ...
          ewRookPawn        = tme (-51) (-43),	-- and here
          ewAdvPawn5        = tme   12  130,	-- and here
          ewAdvPawn6        = tme  440  501,	-- and here
          ewPawnBlockP      = tme (-116)(-105),
          ewPawnBlockO      = tme (-22) (-27),	-- and here
          ewPawnBlockA      = tme (-15) (-74),	-- and here
          ewPassPawnLev     = tme (-1) 10	-- and here (!)
        }
