...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 169,		-- SGD with combined target - intercept added
                    epMovingEnd  = 139,		-- SGD with combined target - intercept added
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 190 150,
          ewRookOpen        = tme 214 212,
          ewRookConn        = tme 104 56,
          ewMobilityKnight  = tme 50 66,
          ewMobilityBishop  = tme 58 28,
          ewMobilityRook    = tme 24 33,
          ewMobilityQueen   = tme 2 13,
          ewCenterPAtts     = tme 80 72,
          ewCenterNAtts     = tme 48 52,
          ewCenterBAtts     = tme 56 44,
          ewCenterRAtts     = tme 11 38,
          ewCenterQAtts     = tme 10 52,
          ewCenterKAtts     = tme 3 44,
          ewSpace           = tme  1 0,
          ewAdvAtts         = tme  7 14,
          ewIsolPawns       = tme (-41) (-120),
          ewIsolPassed      = tme (-97) (-117),
          ewBackPawns       = tme (-128) (-165),
          ewBackPOpen       = tme (-28) (-23),
          ewEnpHanging      = tme (-24) (-34),
          ewEnpEnPrise      = tme (-32) (-7),
          ewEnpAttacked     = tme 5 (-23),
          ewLastLinePenalty = tme 114 (-3),
          ewBishopPair      = tme 362 369,
          ewRedundanceRook  = tme (-7) (-85),
          ewRookPawn        = tme (-47) (-37),
          ewAdvPawn5        = tme (-7) 138,
          ewAdvPawn6        = tme 435 365,
          ewPawnBlockP      = tme (-135) (-111),
          ewPawnBlockO      = tme (-27) (-24),
          ewPawnBlockA      = tme (-15) (-74),
