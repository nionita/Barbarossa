...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 176 192,
          ewRookOpen        = tme 224 212,
          ewRookConn        = tme 103  57,
          ...
          ewIsolPassed      = tme (-63) (-158),
          ewBackPawns       = tme (-126) (-169),
          ewBackPOpen       = tme (-27)  (-21),
          ewEnpHanging      = tme (-23) (-33),
          ewEnpEnPrise      = tme (-27) (-20),
          ewEnpAttacked     = tme  (-6) (-15),
          ewLastLinePenalty = tme 115 (-2),
          ewBishopPair      = tme 381 330,
          ewRedundanceRook  = tme (-20) (-76),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    5 132,
          ewAdvPawn6        = tme  431 413,
          ewPawnBlockP      = tme (-128) (-105),
