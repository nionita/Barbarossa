...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 5 1,
          ewKingPlaceCent   = tme 7 0,
          ewKingPlacePwns   = tme 1 7,
          ewKingPawn1       = tme 8 48,
          ewKingPawn2       = tme 12 66,
          ewRookHOpen       = tme 159 179,
          ewRookOpen        = tme 212 187,
          ewRookConn        = tme 93  53,
          ewMobilityKnight  = tme 47 61,
          ewMobilityBishop  = tme 53 29,
          ewMobilityRook    = tme 23 24,
          ewMobilityQueen   = tme  4  5,
          ewCenterPAtts     = tme 76 60,
          ewCenterNAtts     = tme 46 42,
          ewCenterBAtts     = tme 52 40,
          ewCenterRAtts     = tme 10 30,
          ewCenterQAtts     = tme  3 57,
          ewCenterKAtts     = tme  2 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 14,
          ewIsolPawns       = tme (-38) (-108),
          ewIsolPassed      = tme (-50) (-152),
          ewBackPawns       = tme (-114) (-151),
          ewBackPOpen       = tme (-22)  (-21),
          ewEnpHanging      = tme (-20) (-33),
          ewEnpEnPrise      = tme (-26) (-27),
          ewEnpAttacked     = tme  (-6) (-6),
          ewWepAttacked     = tme 49 64,
          ewLastLinePenalty = tme 106 3,
          ewBishopPair      = tme 391 320,
          ewBishopPawns     = tme (-21) (-58),
          ewRedundanceRook  = tme (-30) (-61),
          ewRookPawn        = tme (-46) (-38),
          ewAdvPawn5        = tme    5 118,
          ewAdvPawn6        = tme  357 333,
          ewPawnBlockP      = tme (-114) (-91),
          ewPawnBlockO      = tme  (-20) (-22),
          ewPawnBlockA      = tme  (-13) (-72),
          ewPassPawnLev     = tme 1 7
        }
