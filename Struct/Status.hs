...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 144,		-- after Clop optimisation
                    epMovingEnd  = 144,		-- with 3700 games at 15+0.25 s
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 175 192,
          ewRookOpen        = tme 224 212,
          ewRookConn        = tme 100  69,
          ewMobilityKnight  = tme 51 69,	-- Evalo 200 steps:
          ewMobilityBishop  = tme 57 32,	-- length 10, depth 6, batch 128
          ewMobilityRook    = tme 27 27,
          ewMobilityQueen   = tme  4  6,
          ewCenterPAtts     = tme 83 68,
          ewCenterNAtts     = tme 48 46,
          ewCenterBAtts     = tme 56 42,
          ewCenterRAtts     = tme 10 33,
          ewCenterQAtts     = tme  5 57,
          ewCenterKAtts     = tme  1 52,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 16,
          ewIsolPawns       = tme (-42) (-120),
          ewIsolPassed      = tme (-65) (-157),
          ewBackPawns       = tme (-123) (-172),
          ewBackPOpen       = tme (-31)  (-16),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-27) (-20),
          ewEnpAttacked     = tme  (-6) (-15),
          ewLastLinePenalty = tme 116 (-3),
          ewBishopPair      = tme 382 326,
          ewRedundanceRook  = tme (-17) (-84),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    4 132,
          ewAdvPawn6        = tme  423 412,
          ewPawnBlockP      = tme (-129) (-104),
          ewPawnBlockO      = tme  (-23) (-25),
          ewPawnBlockA      = tme  (-14) (-72),
