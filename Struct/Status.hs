...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 186 206,	-- evroo after 456 steps
          ewRookOpen        = tme 237 224,	-- evroo after 456 steps
          ewRookConn        = tme  75  65,	-- evroo after 456 steps
          ewMobilityKnight  = tme 50 71,	-- Evalo 200 steps:
          ewMobilityBishop  = tme 57 33,	-- length 10, depth 6, batch 128
          ewMobilityRook    = tme 49 14,	-- evroo after 456 steps
          ewMobilityQueen   = tme  4  6,
          ewCenterPAtts     = tme 68 65,
          ewCenterNAtts     = tme 52 48,
          ewCenterBAtts     = tme 60 41,
          ewCenterRAtts     = tme 10 64,	-- evroo after 456 steps
          ...
          ewRedundanceRook  = tme (-17) (-37),	-- evroo after 456 steps
