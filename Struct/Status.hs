...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 158 185,	-- DSPSA rook3
          ewRookOpen        = tme 202 177,	-- DSPSA rook3
          ewRookConn        = tme  83  56,	-- DSPSA rook3
          ewRook7th         = tme 196 161,	-- DSPSA rook3
          ewMobilityKnight  = tme 50 56,
          ewMobilityBishop  = tme 53 33,
          ewMobilityRook    = tme  9 34,	-- DSPSA rook3
          ewMobilityQueen   = tme  2 11,
          ewCenterPAtts     = tme 73 57,
          ewCenterNAtts     = tme 48 37,
          ewCenterBAtts     = tme 52 35,
          ewCenterRAtts     = tme 13 21,	-- DSPSA rook3
          ...
          ewRedundanceRook  = tme (-26) (-52),	-- DSPSA rook3
