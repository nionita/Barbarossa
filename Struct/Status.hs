...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingPlacePwns   = tme 1 5,
          ewKingPawn1       = tme 8 48,
          ewKingPawn2       = tme 11 64,
          ewRookHOpen       = tme 160 179,
          ewRookOpen        = tme 211 185,
          ewRookConn        = tme 94  53,
          ewMobilityKnight  = tme 45 61,
          ewMobilityBishop  = tme 52 27,
          ewMobilityRook    = tme 23 24,
          ewMobilityQueen   = tme  4  3,
          ewCenterPAtts     = tme 76 59,
          ewCenterNAtts     = tme 44 40,
          ewCenterBAtts     = tme 53 39,
          ewCenterRAtts     = tme  9 30,
          ewCenterQAtts     = tme  4 56,
          ewCenterKAtts     = tme  1 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  2 13,
          ewIsolPawns       = tme (-36) (-107),
          ewIsolPassed      = tme (-52) (-151),
          ewBackPawns       = tme (-112) (-152),
          ewBackPOpen       = tme (-22)  (-19),
          ewEnpHanging      = tme (-21) (-36),
          ewEnpEnPrise      = tme (-27) (-27),
          ewEnpAttacked     = tme  (-7) (-7),
          ewWepAttacked     = tme 48 64,
          ewLastLinePenalty = tme 106 3,
          ewBishopPair      = tme 389 321,
          ewBishopPawns     = tme (-21) (-58),
          ewRedundanceRook  = tme (-29) (-61),
          ewRookPawn        = tme (-48) (-36),
          ewAdvPawn5        = tme    5 117,
          ewAdvPawn6        = tme  358 335,
          ewPawnBlockP      = tme (-115) (-91),
          ewPawnBlockO      = tme  (-20) (-21),
          ewPawnBlockA      = tme  (-14) (-70),
          ewPassPawnLev     = tme (-1) 10
        }
