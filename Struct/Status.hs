...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 152 171,
          ewRookOpen        = tme 200 177,
          ewRookConn        = tme 89  50,
          ewMobilityKnight  = tme 44 58,
          ewMobilityBishop  = tme 49 28,
          ewMobilityRook    = tme 22 24,
          ewMobilityQueen   = tme  4  3,
          ewCenterPAtts     = tme 72 56,
          ewCenterNAtts     = tme 42 39,
          ewCenterBAtts     = tme 49 36,
          ewCenterRAtts     = tme 10 28,
          ewCenterQAtts     = tme  4 52,
          ewCenterKAtts     = tme  2 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  2 13,
          ewIsolPawns       = tme (-35) (-103),
          ewIsolPassed      = tme (-48) (-144),
          ewBackPawns       = tme (-107) (-143),
          ewBackPOpen       = tme (-22)  (-19),
          ewEnpHanging      = tme (-21) (-34),
          ewEnpEnPrise      = tme (-28) (-26),
          ewEnpAttacked     = tme  (-6) (-7),
          ewWepAttacked     = tme 46 61,
          ewLastLinePenalty = tme 102 3,
          ewBishopPair      = tme 390 320,
          ewBishopPawns     = tme (-21) (-55),
          ewRedundanceRook  = tme (-28) (-58),
          ewRookPawn        = tme (-45) (-35),
          ewAdvPawn5        = tme    4 112,
          ewAdvPawn6        = tme  338 317,
          ewPawnBlockP      = tme (-109) (-85),
          ewPawnBlockO      = tme  (-19) (-22),
          ewPawnBlockA      = tme  (-12) (-66),
