...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 4 0,
          ewKingPlaceCent   = tme 6 2,
          ewKingPlacePwns   = tme 0 4,
          ewKingPawn1       = tme 7 49,
          ewKingPawn2       = tme 12 64,
          ewRookHOpen       = tme 158 183,
          ewRookOpen        = tme 212 185,
          ewRookConn        = tme 96  54,
          ewMobilityKnight  = tme 45 60,
          ewMobilityBishop  = tme 51 30,
          ewMobilityRook    = tme 23 24,
          ewMobilityQueen   = tme  5  4,
          ewCenterPAtts     = tme 77 56,
          ewCenterNAtts     = tme 43 39,
          ewCenterBAtts     = tme 49 36,
          ewCenterRAtts     = tme  8 29,
          ewCenterQAtts     = tme  7 55,
          ewCenterKAtts     = tme  4 55,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  4 13,
          ewIsolPawns       = tme (-38) (-109),
          ewIsolPassed      = tme (-48) (-154),
          ewBackPawns       = tme (-112) (-150),
          ewBackPOpen       = tme (-24)  (-19),
          ewEnpHanging      = tme (-20) (-35),
          ewEnpEnPrise      = tme (-28) (-28),
          ewEnpAttacked     = tme  (-9) (-8),
          ewWepAttacked     = tme 47 64,
          ewLastLinePenalty = tme 108 8,
          ewBishopPair      = tme 388 318,
          ewBishopPawns     = tme (-24) (-59),
          ewRedundanceRook  = tme (-30) (-61),
          ewRookPawn        = tme (-48) (-38),
          ewAdvPawn5        = tme    5 116,
          ewAdvPawn6        = tme  355 334,
          ewPawnBlockP      = tme (-115) (-91),
          ewPawnBlockO      = tme  (-22) (-26),
          ewPawnBlockA      = tme  (-14) (-71),
