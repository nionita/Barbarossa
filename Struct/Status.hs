...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 175 205,
          ewRookOpen        = tme 232 212,
          ewRookConn        = tme 106  52,
          ...
          ewIsolPassed      = tme (-65) (-165),
          ewBackPawns       = tme (-124) (-169),
          ewBackPOpen       = tme (-29)  (-21),
          ewEnpHanging      = tme (-21) (-34),
          ewEnpEnPrise      = tme (-28) (-26),
          ewEnpAttacked     = tme  (-6) (-7),
          ewLastLinePenalty = tme 118 4,
          ewBishopPair      = tme 389 314,
          ewRedundanceRook  = tme (-23) (-79),
          ewRookPawn        = tme (-52) (-41),
          ewAdvPawn5        = tme    5 131,
          ewAdvPawn6        = tme  401 380,
          ewPawnBlockP      = tme (-127) (-102),
          ewPawnBlockO      = tme  (-22) (-26),
          ewPawnBlockA      = tme  (-14) (-76),
