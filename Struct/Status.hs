...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 89 100,
          ewRookOpen        = tme 117 104,
          ewRookConn        = tme 52  30,
          ewMobilityKnight  = tme 25 34,	-- Evalo 200 steps: length 10, depth 6, batch 128
          ewMobilityBishop  = tme 29 16,	-- adjusted bc bishop pawns
          ewMobilityRook    = tme 13 14,
          ewMobilityQueen   = tme  2  2,
          ewCenterPAtts     = tme 42 33,
          ewCenterNAtts     = tme 25 23,
          ewCenterBAtts     = tme 29 21,	-- adjusted bc bishop pawns
          ewCenterRAtts     = tme  6 17,
          ewCenterQAtts     = tme  2 30,
          ewCenterKAtts     = tme  2 54,
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  1  8,
          ewIsolPawns       = tme (-21) (-60),
          ewIsolPassed      = tme (-27) (-85),
          ewBackPawns       = tme (-63) (-84),
          ewBackPOpen       = tme (-13)  (-11),
          ewEnpHanging      = tme (-22) (-34),
          ewEnpEnPrise      = tme (-28) (-26),
          ewEnpAttacked     = tme  (-6) (-7),
          ewWepAttacked     = tme 48 64,
          ewLastLinePenalty = tme 60 2,
          ewBishopPair      = tme 390 320,
          ewBishopPawns     = tme (-12) (-32),
          ewRedundanceRook  = tme (-16) (-33),
          ewRookPawn        = tme (-26) (-21),
          ewAdvPawn5        = tme    2 66,
          ewAdvPawn6        = tme  200 185,
          ewPawnBlockP      = tme (-64) (-50),
          ewPawnBlockO      = tme  (-11) (-13),
          ewPawnBlockA      = tme  (-7) (-38),
