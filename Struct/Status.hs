...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewAdvNAtts        = tme  8  6,	-- mid & end: bo with new logic
          ewAdvBAtts        = tme  8 24,	-- after 256 steps (1104 short tournaments)
          ewAdvRAtts        = tme  5 16,	-- 8 params
          ewAdvQAtts        = tme  5  5,	-- at once
