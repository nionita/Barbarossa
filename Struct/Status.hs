...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 1 9,	-- DSPSA
          ewKingPlaceCent   = tme 4 17,	-- DSPSA
          ewKingPlacePwns   = tme (-2) 1,	-- DSPSA
          ewKingPawn1       = tme  4 55,	-- DSPSA
          ewKingPawn2       = tme  1 68,	-- DSPSA
          ewRookHOpen       = tme 161 181,	-- DSPSA
          ewRookOpen        = tme 206 179,	-- DSPSA
          ewRookConn        = tme  89  59,	-- DSPSA
          ewRook7th         = tme 202 161,	-- DSPSA
          ewMobilityKnight  = tme 48 54,	-- DSPSA
          ewMobilityBishop  = tme 56 32,	-- DSPSA
          ewMobilityRook    = tme 17 38,	-- DSPSA
          ewMobilityQueen   = tme  8 14,	-- DSPSA
          ewCenterPAtts     = tme 73 54,	-- DSPSA
          ewCenterNAtts     = tme 46 37,	-- DSPSA
          ewCenterBAtts     = tme 54 34,	-- DSPSA
          ewCenterRAtts     = tme 15 22,	-- DSPSA
          ewCenterQAtts     = tme 11 51,	-- DSPSA
          ewCenterKAtts     = tme  0 62,	-- DSPSA
          ewSpace           = tme  1 (-1),	-- DSPSA
          ewAdvAtts         = tme (-4) 18,	-- DSPSA
          ewIsolPawns       = tme (-38) (-114),	-- DSPSA
          ewIsolPassed      = tme (-63) (-144),	-- DSPSA
          ewBackPawns       = tme (-108) (-141),	-- DSPSA
          ewBackPOpen       = tme (-21) (-28),	-- DSPSA
          ewEnpHanging      = tme (-20) (-26),	-- DSPSA
          ewEnpEnPrise      = tme (-34) (-26),	-- DSPSA
          ewEnpAttacked     = tme  (-2) (-11),	-- DSPSA
          ewWepAttacked     = tme 35 74,	-- DSPSA
          ewLastLinePenalty = tme 101 0,	-- DSPSA
          ewBishopPair      = tme 386 323,	-- DSPSA
          ewBishopPawns     = tme (-24) (-54),	-- DSPSA
          ewRedundanceRook  = tme (-28) (-50),	-- DSPSA
          ewRookPawn        = tme (-43) (-32),	-- DSPSA
          ewAdvPawn5        = tme   15 107,	-- DSPSA
          ewAdvPawn6        = tme  353 333,	-- DSPSA
          ewPawnBlockP      = tme (-113) (-92),	-- DSPSA
          ewPawnBlockO      = tme  (-22) (-26),	-- DSPSA
          ewPawnBlockA      = tme  (-17) (-69),	-- DSPSA
          ewPassPawnLev     = tme 2 9	-- DSPSA
        }
