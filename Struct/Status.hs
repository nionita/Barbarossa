...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingPlacePwns   = tme 0 29,		-- 5338 steps evalo
          ...
          ewCenterPAtts     = tme 69 69,	-- 5338 steps evalo
          ewCenterNAtts     = tme 52 48,
          ewCenterBAtts     = tme 60 41,
          ewCenterRAtts     = tme 11 36,
          ewCenterQAtts     = tme  4 62,
          ewCenterKAtts     = tme  0 56,
          ewAdvAtts         = tme  2 16,	-- 5338 steps evalo
          ewIsolPawns       = tme (-36) (-119),	-- and here
          ewIsolPassed      = tme (-60) (-155),	-- and here
          ewBackPawns       = tme (-104) (-180),	-- and here
          ewBackPOpen       = tme (-35)    0,	-- and here
          ...
          ewRookPawn        = tme (-50) (-44),	-- and here
          ewAdvPawn5        = tme   12  133,	-- and here
          ewAdvPawn6        = tme  437  500,	-- and here
          ewPawnBlockP      = tme (-114)(-106),
          ewPawnBlockO      = tme (-26) (-25),	-- and here
          ewPawnBlockA      = tme (-14) (-73),	-- and here
          ewPassPawnLev     = tme 0 9		-- and here
        }
