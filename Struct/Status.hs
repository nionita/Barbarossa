...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 16,
          ewIsolPawns       = tme (-42) (-121),
          ewIsolPassed      = tme (-68) (-156),
          ewBackPawns       = tme (-125) (-171),
          ewBackPOpen       = tme (-28)  (-17),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-27) (-20),
          ewEnpAttacked     = tme  (-6) (-15),
          ewLastLinePenalty = tme 116 (-2),
          ewBishopPair      = tme 383 325,
          ewRedundanceRook  = tme (-24) (-73),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    4 132,
          ewAdvPawn6        = tme  418 429,
          ewPawnBlockP      = tme (-131) (-100),
