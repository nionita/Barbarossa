...
instance CollectParams EvalParams where
    ...
    npColInit = EvalParams {
                    epMovingMid  = 16,		-- SGD with combined target
                    epMovingEnd  = 16,		-- SGD with combined target
                    epMaterMinor = 1,
                    epMaterRook  = 4,
                    epMaterQueen = 13,
                    epMaterScale = 1,
...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 159 71,
          ewRookOpen        = tme 190 125,
          ewRookConn        = tme 104 42,
          ewMobilityKnight  = tme 46 75,
          ewMobilityBishop  = tme 61 37,
          ewMobilityRook    = tme 30 33,
          ewMobilityQueen   = tme 2 6,
          ewCenterPAtts     = tme 82 54,
          ewCenterNAtts     = tme 58 29,
          ewCenterBAtts     = tme 61 35,
          ewCenterRAtts     = tme 17 36,
          ewCenterQAtts     = tme  7 53,
          ewCenterKAtts     = tme 18 45,
          ewSpace           = tme  1 0,
          ewAdvAtts         = tme  4 16,
          ewIsolPawns       = tme (-42) (-119),
          ewIsolPassed      = tme (-47) (-119),
          ewBackPawns       = tme (-113) (-123),
          ewBackPOpen       = tme (-61) (-39),
          ewEnpHanging      = tme (-24) (-32),
          ewEnpEnPrise      = tme (-27) (-14),
          ewEnpAttacked     = tme (-4) (-20),
          ewLastLinePenalty = tme 100 4,
          ewBishopPair      = tme 328 122,
          ewRedundanceRook  = tme (-29) (-17),
          ewRookPawn        = tme (-74) (-47),
          ewAdvPawn5        = tme  11 83,
          ewAdvPawn6        = tme  83 66,
          ewPawnBlockP      = tme (-78) (-55),
          ewPawnBlockO      = tme (-31) (-16),
          ewPawnBlockA      = tme (-21) (-26),
