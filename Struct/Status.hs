...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 128 127,	-- evcro after 1111 steps
          ewRookOpen        = tme 137 124,	-- evcro after 1111 steps
          ewRookConn        = tme  77  59,	-- evcro after 1111 steps
          ewMobilityKnight  = tme 50 71,	-- Evalo 200 steps:
          ewMobilityBishop  = tme 57 33,	-- length 10, depth 6, batch 128
          ewMobilityRook    = tme 23 21,	-- evcro after 1111 steps
          ewMobilityQueen   = tme  4  6,
          ewCenterPAtts     = tme 68 65,
          ewCenterNAtts     = tme 52 48,
          ewCenterBAtts     = tme 60 41,
          ewCenterRAtts     = tme  9 22,	-- evcro after 1111 steps
          ...
          ewRedundanceRook  = tme (-191) (-177),	-- evcro after 1111 steps
