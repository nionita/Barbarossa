...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 1 4,		-- DSPSA...
          ewKingPlaceCent   = tme 7 (-3),	-- DSPSA...
          ewKingPlacePwns   = tme 1 3,		-- DSPSA...
          ewKingThreat1     = tme 22 466,	-- DSPSA...
          ewKingThreat2     = tme 37 1045,	-- DSPSA...
