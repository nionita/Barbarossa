...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingPlacePwns   = tme 0 7,		-- max after ~12k Clop games (ELO +23 +- 12)
          ewRookHOpen       = tme 89 7,
          ewRookOpen        = tme 96 123,
          ewRookConn        = tme 87 25,
          ewMobilityKnight  = tme 38 22,	-- Evalo 200 steps:
          ewMobilityBishop  = tme 58 1,	-- length 10, depth 6, batch 128
          ewMobilityRook    = tme 62 1,
          ewMobilityQueen   = tme 2 0,
          ewCenterPAtts     = tme 83 4,
          ewCenterNAtts     = tme 96 34,
          ewCenterBAtts     = tme 140 76,
          ewCenterRAtts     = tme 60 18,
          ewCenterQAtts     = tme 26 185,
          ewCenterKAtts     = tme 48 54,
          ewSpace           = tme 1  0,
          ewAdvAtts         = tme 0 24,
          ewIsolPawns       = tme (-94) (-95),
          ewIsolPassed      = tme (-60) (-125),
          ewBackPawns       = tme (-105) (-116),
          ewBackPOpen       = tme (-32) (-38),
          ewEnpHanging      = tme 0 (-169),
          ewEnpEnPrise      = tme (-173) 0,
          ewEnpAttacked     = tme (-1) (-1),
          ewLastLinePenalty = tme 133 44,
          ewBishopPair      = tme 235 75,
          ewRedundanceRook  = tme (-54) (-34),
          ewRookPawn        = tme (-138) (-115),
          ewAdvPawn5        = tme  0  35,
          ewAdvPawn6        = tme  38 47,
          ewPawnBlockP      = tme (-16) 0,
          ewPawnBlockO      = tme (-82) (-10),
          ewPawnBlockA      = tme (-15) (-47),
