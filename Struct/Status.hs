...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 3 4,		-- DSPSA...
          ewKingPlaceCent   = tme 9 0,		-- DSPSA...
          ewKingPlacePwns   = tme 3 4,		-- DSPSA...
          ewKingThreat1     = tme 23 467,	-- DSPSA...
          ewKingThreat2     = tme 36 1046,	-- DSPSA...
