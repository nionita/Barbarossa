...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingSafe        = tme 1 0,
          ewKingOpen        = tme 1 11,
          ewKingPlaceCent   = tme 10 1,
          ewKingPlacePwns   = tme 8 4,
          ewKingPawn1       = tme  4 54,
          ewKingPawn2       = tme  1 67,
          ewRookHOpen       = tme 162 181,	-- DSPSA with Adadelta
          ewRookOpen        = tme 205 179,	-- 20k steps, depth 4,
          ewRookConn        = tme  89  59,	-- 2 games, beta=0.95, gamma=0.8,
          ewRook7th         = tme 201 161,	-- niu=0.99, eps=1E-6
          ewMobilityKnight  = tme 49 55,
          ewMobilityBishop  = tme 55 34,
          ewMobilityRook    = tme 16 37,	-- DSPSA ...
          ewMobilityQueen   = tme  4 11,
          ewCenterPAtts     = tme 73 56,
          ewCenterNAtts     = tme 47 37,
          ewCenterBAtts     = tme 53 35,
          ewCenterRAtts     = tme 15 21,	-- DSPSA ...
          ewCenterQAtts     = tme 11 53,
          ewCenterKAtts     = tme  2 62,
          ewSpace           = tme  0  0,
          ewAdvAtts         = tme (-1) 17,
          ewIsolPawns       = tme (-36) (-113),
          ewIsolPassed      = tme (-63) (-144),
          ewBackPawns       = tme (-108) (-140),
          ewBackPOpen       = tme (-21)  (-28),
          ewEnpHanging      = tme (-18) (-25),
          ewEnpEnPrise      = tme (-32) (-26),
          ewEnpAttacked     = tme  (-2) (-12),
          ewWepAttacked     = tme 35 74,
          ewLastLinePenalty = tme 100 0,
          ewBishopPair      = tme 386 323,
          ewBishopPawns     = tme (-25) (-54),
          ewRedundanceRook  = tme (-27) (-51),	-- DSPSA ...
          ewRookPawn        = tme (-44) (-33),
          ewAdvPawn5        = tme   15 107,
          ewAdvPawn6        = tme  353 334,
