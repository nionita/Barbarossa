...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewRookHOpen       = tme 177 187,
          ewRookOpen        = tme 228 205,
          ewRookConn        = tme 100 63,
          ...
          ewCenterPAtts     = tme 83 67,
          ewCenterNAtts     = tme 48 47,
          ...
          ewSpace           = tme  1  0,
          ewAdvAtts         = tme  3 16,
          ewIsolPawns       = tme (-41) (-121),
          ewIsolPassed      = tme (-66) (-159),
          ewBackPawns       = tme (-124) (-169),
          ewBackPOpen       = tme (-30) (-21),
          ewEnpHanging      = tme (-23) (-32),
          ewEnpEnPrise      = tme (-26) (-22),
          ewEnpAttacked     = tme  (-7) (-13),
          ewLastLinePenalty = tme 118 (-7),
          ewBishopPair      = tme 389  301,
          ewRedundanceRook  = tme (-29) (-63),
          ewRookPawn        = tme (-48) (-41),
          ewAdvPawn5        = tme    3  132,
          ewAdvPawn6        = tme  406  362,
          ewPawnBlockP      = tme (-133) (-90),
          ewPawnBlockO      = tme  (-22) (-26),
          ewPawnBlockA      = tme  (-15) (-69),
