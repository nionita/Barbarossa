...
weights = [
        ...
        ("ewSpace",           (   1,    0)),
        ("ewAdvAtts",         (   1,   17)),
        ("ewIsolPawns",       ( -20,  -96)),	-- Bayes
        ("ewBackPawns",       ( -95, -113)),	-- Bayes
        ("ewBackPOpen",       ( -73,  -15)),	-- Bayes
        ("ewEnpHanging",      ( -19,  -27)),
        ("ewEnpEnPrise",      ( -29,  -26)),
        ("ewEnpAttacked",     (  -2,  -14)),
        ("ewWepTotal",        (  76,   21)),	-- Bayes
        ("ewWepAttacked",     (   0,  148)),	-- Bayes
