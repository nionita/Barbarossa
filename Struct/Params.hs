...
weights = [
        ...
        ("ewMobilityKnight",  (  13,    3)),	-- new mobility, Bayes
        ("ewMobilityBishop",  (  11,    2)),	-- new mobility, Bayes
        ("ewMobilityRook",    (   3,    2)),	-- new mobility, Bayes
        ("ewMobilityQueen",   (   0,    1)),	-- new mobility, Bayes
        ("ewMobility",        (  10,    0)),	-- new mobility, Bayes
        ("ewCenterPAtts",     (  73,   57)),
        ("ewCenterNAtts",     (  48,   37)),
        ("ewCenterBAtts",     (  52,   35)),
