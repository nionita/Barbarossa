...
weights = [
        ...
        ("ewSpace",           (   1,    0)),
        ("ewAdvAtts",         (   1,   17)),
        ("ewIsolPawns",       ( -10,  -85)),	-- Bayes
        ("ewBackPawns",       ( -99, -125)),	-- Bayes
        ("ewBackPOpen",       ( -91,    0)),	-- Bayes
        ("ewEnpHanging",      ( -19,  -27)),
        ("ewEnpEnPrise",      ( -29,  -26)),
        ("ewEnpAttacked",     (  -2,  -14)),
        ("ewWepTotal",        (  84,   18)),	-- Bayes
        ("ewWepAttacked",     (   0,  177)),	-- Bayes
