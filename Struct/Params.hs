...
weights = [
        ...
        ("ewSpace",           (   1,    0)),
        ("ewAdvAtts",         (   1,   17)),
        ("ewIsolPawns",       ( -36, -112)),	-- Bayes
        ("ewBackPawns",       (-119, -121)),	-- Bayes
        ("ewBackPOpen",       ( -50, -118)),	-- Bayes
        ("ewEnpHanging",      ( -19,  -27)),
        ("ewEnpEnPrise",      ( -29,  -26)),
        ("ewEnpAttacked",     (  -2,  -14)),
        ("ewWepTotal",        ( 151,    0)),	-- Bayes
        ("ewWepAttacked",     (   0,  167)),	-- Bayes
