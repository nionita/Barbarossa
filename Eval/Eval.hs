...
instance EvalItem RookPlc where
    ...
    evalItemNDL _  = [ ("rookHOpen", ((368, 300), (0, 500))),
                       ("rookOpen",  ((495, 338), (0, 800))) ]
...
instance EvalItem Mobility where
    ...
    evalItemNDL _  = [ ("mobilityKnight", ((106, 90), (50, 120))),
                       ("mobilityBishop", ((59, 70), (50, 120))),
                       ("mobilityRook",   ((19, 33), ( 0, 100))),
                       ("mobilityQueen",  (( 1, 10), (-5,  50))) ]
...
instance EvalItem PassPawns where
    ...
    evalItemNDL _  = [("passPawnBonus", ((  62,   85), (   0,  200))),
                      ("passPawn4",     (( 343,  300), ( 200,  520))),
                      ("passPawn5",     (( 474,  493), ( 250,  740))),
                      ("passPawn6",     (( 877,  892), ( 500, 1200))),
                      ("passPawn7",     ((1595, 1606), ( 900, 2300)))
                     ]
