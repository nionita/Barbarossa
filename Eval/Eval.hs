...
instance EvalItem RookPlc where
    ...
    evalItemNDL _  = [ ("rookHOpen", ((258, 231), (0, 500))),
                       ("rookOpen",  ((334, 318), (0, 800))) ]
...
instance EvalItem Mobility where
    ...
    evalItemNDL _  = [ ("mobilityKnight", ((70, 76), (50, 120))),
                       ("mobilityBishop", ((65, 78), (50, 120))),
                       ("mobilityRook",   ((42, 35), ( 0, 100))),
                       ("mobilityQueen",  (( 6, 14), (-5,  50))) ]
...
instance EvalItem PassPawns where
    ...
    evalItemNDL _  = [("passPawnBonus", ((  69,   87), (   0,  200))),
                      ("passPawn4",     (( 348,  339), ( 200,  520))),
                      ("passPawn5",     (( 481,  480), ( 250,  740))),
                      ("passPawn6",     (( 820,  804), ( 500, 1200))),
                      ("passPawn7",     ((1505, 1459), ( 900, 2300)))
                     ]
