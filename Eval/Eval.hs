...
instance EvalItem RookPlc where
    ...
    evalItemNDL _  = [ ("rookHOpen", ((211, 267), (0, 500))),
                       ("rookOpen",  ((273, 252), (0, 800))) ]
...
instance EvalItem Mobility where
    ...
    evalItemNDL _  = [ ("mobilityKnight", ((64, 76), (50, 120))),
                       ("mobilityBishop", ((60, 72), (50, 120))),
                       ("mobilityRook",   ((29, 29), ( 0, 100))),
                       ("mobilityQueen",  (( 0,  9), (-5,  50))) ]
...
instance EvalItem PassPawns where
    ...
    evalItemNDL _  = [("passPawnBonus", ((  55,   80), (   0,  200))),
                      ("passPawn4",     (( 329,  330), ( 200,  520))),
                      ("passPawn5",     (( 493,  477), ( 250,  740))),
                      ("passPawn6",     (( 846,  836), ( 500, 1200))),
                      ("passPawn7",     ((1525, 1479), ( 900, 2300)))
                     ]
