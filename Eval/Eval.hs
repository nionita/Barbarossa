...
instance EvalItem RookPlc where
    ...
    evalItemNDL _  = [ ("rookHOpen", ((359, 316), (0, 500))),
                       ("rookOpen",  ((487, 349), (0, 800))) ]
...
instance EvalItem Mobility where
    ...
    evalItemNDL _  = [ ("mobilityKnight", ((105, 89), (50, 120))),
                       ("mobilityBishop", ((59, 72), (50, 120))),
                       ("mobilityRook",   ((21, 32), ( 0, 100))),
                       ("mobilityQueen",  (( 1,  9), (-5,  50))) ]
...
instance EvalItem PassPawns where
    ...
    evalItemNDL _  = [("passPawnBonus", ((  67,   89), (   0,  200))),
                      ("passPawn4",     (( 338,  297), ( 200,  520))),
                      ("passPawn5",     (( 466,  491), ( 250,  740))),
                      ("passPawn6",     (( 884,  907), ( 500, 1200))),
                      ("passPawn7",     ((1647, 1588), ( 900, 2300)))
                     ]
